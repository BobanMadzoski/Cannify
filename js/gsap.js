...
gsap.registerPlugin(ScrollTrigger);
    ...
    ScrollTrigger.batch(".research-horizontal" , {onEnter : batch => gsap.fromTo (batch, {delay:1, duration: 0.7, opacity:0, transformOrigin: "top bottom", scaleY: 0}, {delay:1, transformOrigin: "top bottom", scaleY: 1, opacity:1})})
